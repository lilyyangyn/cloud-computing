...
def plot(ipath, opath, save):
	...
	raw_cpu_2_1 = read_file_cpu(ipath, "2_1_cpu.txt", start_times_2_1, 1)
	cpu_2_1_temp = np.array(raw_cpu_2_1)[0]
	...
	ax1.set_yticks(np.arange(0, 3.1, 0.2)) # 0 - 4ms
	...
	ax2.set_yticks(np.arange(0, 3.1, 0.2)) # 0 - 4ms
